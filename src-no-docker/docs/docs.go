...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/swift-codes/{swift-code}": {
            "get": {
                "description": "Returns headquarter (with branches) or standalone branch",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "SWIFT entity\" example {\"type\":\"branch\",\"address\":\"Sesame Street 8\",\"bankName\":\"WorldWide Bank at Cracow\",\"countryISO\":\"PB\",\"countryName\":\"Pitbulland\",\"isHeadquarter\":false,\"swiftCode\":\"MRWORLDWIDE\"}",
                        "schema": {
                            "type": "object"
                        }
                    }
